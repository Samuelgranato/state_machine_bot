...
from detectors.image.yolo_asset_detector import YoloAssetDetector

# Example: two target types
DETECTOR_CONFIGS = {"enemy": {"model_path": "data/models/yolo_goblin.pt", "target_classes": ["goblin", "orc"]}}
